...
- I felt I did the least well in competing the *final* homework submissions, particularly in cases when the peer commentary was unable to help me address problems I was running into with my code (e.g. making the function for HW 4). I could have managed my time better and attended office hours more frequently instead of waiting for the homework solution to be published to figure out where I went wrong.
- The hardest part was the data replication assignment because it tested my ability to apply everything I learned throughout the semester. The steps seemed straightforward when reading the paper but I had a completely different experience once I actually started working with the data. I definitely learned along the way, but I had to go through many additional steps and ran into a lot of problems along the way. 
...
3. I gained a better understanding of how to interpet the outputs of tests/models in R. Instead of solely focusing on p-values, I feel more comfortable interpreting other components like residuals, variance, confidence intervals, etc.
